        ...
        <div class="col-lg-8">
            <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        <img src="{{ $first_post->featured }}" alt="{{ $first_post->title }}" style="width: 100%; height: 250px">
    ...
    <div class="row">
        <div class="col-lg-6">
            <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        <img src="{{ $second_post->featured }}" alt="{{ $second_post->title }}" style="width: 100%; height: 250px">
                        <div class="overlay"></div>
        ...
        <div class="col-lg-6">
            <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        <img src="{{ $third_post->featured }}" alt="{{ $third_post->title }}" style="width: 100%; height: 250px">
                        <div class="overlay"></div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="case-item">
                                <div class="case-item__thumb">
                                    <img src="{{$post->featured }}" alt="{{ $post->title }}" style="width: 100%; height: 200px">
                                </div>
